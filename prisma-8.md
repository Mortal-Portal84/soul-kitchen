...
Your data contract is the heart of your application. It lives at [`src/app/prisma/contract.ts`](src/app/prisma/contract.ts) and describes your models:
...
```typescript
import { db } from './src/app/prisma/db';
...
| File | Purpose |
|---|---|
| [`src/app/prisma/contract.ts`](src/app/prisma/contract.ts) | Your data contract — define your models here |
| [`prisma.config.ts`](prisma.config.ts) | CLI configuration |
| [`src/app/prisma/db.ts`](src/app/prisma/db.ts) | Database client — `import { db } from './src/app/prisma/db'` |
| `src/app/prisma/contract.json` | Compiled contract (generated) |
| `src/app/prisma/contract.d.ts` | Contract types (generated) |

### Workflow

1. Edit [`src/app/prisma/contract.ts`](src/app/prisma/contract.ts) to add or change models.
